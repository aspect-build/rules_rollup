...
load("@npm_aspect_rules_rollup__rollup__2.70.2__links//:defs.bzl", link_0 = "npm_link_imported_package_store", store_0 = "npm_imported_package_store")
...
def npm_link_all_packages(name = "node_modules", imported_links = []):
    ...
    if not is_root and not link:
        msg = "The npm_link_all_packages() macro loaded from @npm_aspect_rules_rollup//:defs.bzl and called in bazel package '%s' may only be called in the bazel package(s) corresponding to the root package '' and packages ['']" % native.package_name()
        fail(msg)
    link_targets = []
    scope_targets = {}
